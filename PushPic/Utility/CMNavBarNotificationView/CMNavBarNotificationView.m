                          ...
                          andTouchBlock:(CMNotificationSimpleAction)block
{
    if (__notificationWindow == nil)
    {
        ...
        CGRect frame = CGRectMake(0, [[UIScreen mainScreen] bounds].size.height-44, 320, 44);
  ...
  //  NSLog(@"%f %f %f %f",bounds.size.height,bounds.size.width,bounds.origin.x,bounds.origin.y);
