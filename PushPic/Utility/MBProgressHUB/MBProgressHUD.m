...
@implementation MBPushPicProgressView {
...
- (void) beginAnimation
{
    self.animationImages = [NSArray arrayWithObjects:
                            [UIImage imageNamed:@"pushpic_Loading1.png"],
                            [UIImage imageNamed:@"pushpic_Loading2.png"],
                            [UIImage imageNamed:@"pushpic_Loading3.png"],
                            [UIImage imageNamed:@"pushpic_Loading4.png"],
                            [UIImage imageNamed:@"pushpic_Loading5.png"],
                            [UIImage imageNamed:@"pushpic_Loading6.png"],
                            [UIImage imageNamed:@"pushpic_Loading7.png"],
                            [UIImage imageNamed:@"pushpic_Loading8.png"],
                            [UIImage imageNamed:@"pushpic_Loading9.png"],
                            [UIImage imageNamed:@"pushpic_Loading10.png"],
                            nil];
